...
fetch_committees_data <- function() {
    ...
    fetch_current_committees_output <- fetch_current_committees()
    fetch_current_committees_output_summary <- fetch_current_committees(summary = FALSE)

    fetch_former_committees_output <- fetch_former_committees()
    fetch_former_committees_output_summary <- fetch_former_committees(summary = FALSE)
    ...
    write_data(fetch_current_committees_output, "fetch_current_committees_output")
    write_data(fetch_current_committees_output_summary, "fetch_current_committees_output_summary")

    write_data(fetch_former_committees_output, "fetch_former_committees_output")
    write_data(fetch_former_committees_output_summary, "fetch_former_committees_output_summary")
